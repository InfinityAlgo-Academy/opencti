...
class NarrativePopover extends Component {
  ...
  render() {
    ...
    return (
      <KnowledgeSecurity needs={[KNOWLEDGE_KNUPDATE, KNOWLEDGE_KNUPDATE_KNDELETE]} entity='Narrative'>
        <>
          <ToggleButton
            value="popover"
            size="small"
          ...
          >
            ...
            <KnowledgeSecurity needs={[KNOWLEDGE_KNUPDATE_KNDELETE]} entity='Narrative'>
