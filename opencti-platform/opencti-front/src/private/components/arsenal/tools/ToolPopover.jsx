...
class ToolPopover extends Component {
  ...
  submitDelete() {
    ...
    commitMutation({
      ...
      onCompleted: () => {
        ...
        this.handleClose();
        this.props.navigate('/dashboard/arsenal/tools');
      },
    });
  }
  ...
  render() {
    ...
    return (
      <KnowledgeSecurity needs={[KNOWLEDGE_KNUPDATE, KNOWLEDGE_KNUPDATE_KNDELETE]} entity='Tool'>
        <>
          <ToggleButton
            value="popover"
            size="small"
...
export default compose(inject18n, withRouter)(ToolPopover);
