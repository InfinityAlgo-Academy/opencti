...
const CountryPopover = ({ id }: { id: string }) => {
  ...
  return (
    <KnowledgeSecurity needs={[KNOWLEDGE_KNUPDATE, KNOWLEDGE_KNUPDATE_KNDELETE]} entity='Country'>
      <>
        <ToggleButton
          value="popover"
          size="small"
        ...
        <Menu anchorEl={anchorEl} open={Boolean(anchorEl)} onClose={handleClose}>
          ...
          <KnowledgeSecurity needs={[KNOWLEDGE_KNUPDATE_KNDELETE]} entity='Country'>
