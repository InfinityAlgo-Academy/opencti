...
class SectorPopover extends Component {
  ...
  submitDelete() {
    ...
    commitMutation({
      ...
      onCompleted: () => {
        ...
        this.handleClose();
        this.props.navigate('/dashboard/entities/sectors');
      },
    });
  }
  ...
  render() {
    ...
    return (
      <KnowledgeSecurity needs={[KNOWLEDGE_KNUPDATE, KNOWLEDGE_KNUPDATE_KNDELETE]} entity='Sector'>
        <>
          <ToggleButton
            value="popover"
            size="small"
          ...
          >
            ...
            <KnowledgeSecurity needs={[KNOWLEDGE_KNUPDATE_KNDELETE]} entity='Sector'>
...
export default compose(inject18n, withRouter)(SectorPopover);
