...
class SystemPopover extends Component {
  ...
  submitDelete() {
    ...
    commitMutation({
      ...
      onCompleted: () => {
        ...
        this.handleClose();
        this.props.navigate('/dashboard/entities/systems');
      },
    });
  }
  ...
  render() {
    ...
    return (
      <KnowledgeSecurity needs={[KNOWLEDGE_KNUPDATE, KNOWLEDGE_KNUPDATE_KNDELETE]} entity='System'>
        <>
          <ToggleButton
            disabled={disabled}
            value="popover"
          ...
          >
            ...
            <KnowledgeSecurity needs={[KNOWLEDGE_KNUPDATE_KNDELETE]} entity='System'>
