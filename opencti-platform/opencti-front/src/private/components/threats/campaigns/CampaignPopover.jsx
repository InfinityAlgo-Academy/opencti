...
class CampaignPopover extends Component {
  ...
  render() {
    ...
    return (
      <KnowledgeSecurity needs={[KNOWLEDGE_KNUPDATE, KNOWLEDGE_KNUPDATE_KNDELETE]} entity='Campaign'>
        <>
          <ToggleButton
            value="popover"
            size="small"
          ...
          >
            ...
            <KnowledgeSecurity needs={[KNOWLEDGE_KNENRICHMENT]} entity='Campaign'>
              <MenuItem onClick={this.handleOpenEnrichment.bind(this)}>
                {t('Enrich')}
              </MenuItem>
            </KnowledgeSecurity>
            <KnowledgeSecurity needs={[KNOWLEDGE_KNUPDATE_KNDELETE]} entity='Campaign'>
