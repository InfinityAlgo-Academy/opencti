...
const Artifacts: FunctionComponent = () => {
  ...
  const dataColumns: DataTableProps['dataColumns'] = {
    ...
    createdBy: { flexSize: 10, isSortable: isRuntimeSort },
    creator: { flexSize: 10, isSortable: isRuntimeSort },
    objectLabel: { flexSize: 10 },
    created_at: { flexSize: 10 },
    objectMarking: { flexSize: 10, isSortable: isRuntimeSort },
  };
    ...
    <div data-testid="artifact-page">
      <ExportContextProvider>
        ...
        <DataTable
          ...
          filterExportContext={{ entity_type: 'Artifact' }}
        />
        )}
