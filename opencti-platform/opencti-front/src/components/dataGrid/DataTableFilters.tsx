...
export const DataTableDisplayFilters = ({
  ...
  const { storageKey, initialValues, variant } = useContext(DataTableContext);
...
const DataTableFilters = ({
  ...
  const { helpers, viewStorage: { numberOfElements, openExports, redirectionMode } } = usePaginationLocalStorage(storageKey, initialValues, variant !== DataTableVariant.default);
